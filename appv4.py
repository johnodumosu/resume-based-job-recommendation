...
if pdf is not None:
    ...
    query_option = st.selectbox("Choose an option", ["Which job roles align most effectively with my skill set?", "Suggest addition skills needed", "show percentage match per job scale"], index=None)
